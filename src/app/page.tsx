      ...
      <div className="mt-6 flex flex-col">
        <div className="flex items-center justify-between pb-5 border-b border-zinc-200">
          <div className="space-y-1">
            ...
            <span className="text-sm text-zinc-500">Updade your photo and personal details here.</span>
          </div>
        ...
        <form id="settings" action="" className="mt-6 flex flex-col w-full gap-5 divide-y divide-zinc-200">
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue="Carminatti" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="arthurcarminattigit@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            >
              Portifolio projects
              <span className="text-sm font-normal text-zinc-500 block mt-0.5">
                Share a few spippets of your work.
              </span>
            </label>
            <FileInput.Root>
              <FileInput.Trigger />
